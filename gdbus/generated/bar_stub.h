...
class BarStub : public sigc::trackable {
public:
    BarStub();
    virtual ~BarStub();

    BarStub(const BarStub &other) = delete;
    BarStub(BarStub &&other) = delete;
    BarStub &operator=(const BarStub &other) = delete;
    BarStub &operator=(BarStub &&other) = delete;
...
protected:
    ...
    void Signal_emitter(const std::vector<Glib::ustring> &destination_bus_names, gint32);
    sigc::signal<void, gint32> Signal_signal;
    sigc::signal<void, const std::vector<Glib::ustring>&, gint32> Signal_selectiveSignal;
...
class BarStub::MethodInvocation {
public:
